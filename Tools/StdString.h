...
//
//	  2000-MAR-07 - Thanks to Ullrich Poll臧ne for catching a range bug in one
...
public:
	...
	// They also are compiled if you have explicitly turned off refcounting
		...
		MYTYPE& assign(const MYTYPE& str, MYSIZE nStart, MYSIZE nChars)
		{
			...
			// value.  Thanks to Ullrich Poll臧ne for catching this bug
...
//		}
				...
				const A20& v20, const A21& v21)
    {
		...
		if ( strFmt.Load(nId) )
        {
            Fmt(strFmt, FmtArg<A1>(v1)(), FmtArg<A2>(v2)(),
                ...
                FmtArg<A12>(v12)(),FmtArg<A13>(v13)(),FmtArg<A14>(v14)(),
                FmtArg<A15>(v15)(),FmtArg<A16>(v16)(),FmtArg<A17>(v17)(),
				FmtArg<A18>(v18)(),FmtArg<A19>(v19)(),FmtArg<A20>(v20)(),
				FmtArg<A21>(v21)());
        }
    }
    ...
    void Format(UINT nId, const A1& v1, const A2& v2, const A3& v3,
                ...
                const A12& v12, const A13& v13, const A14& v14, const A15& v15,
                const A16& v16, const A17& v17, const A18& v18, const A19& v19,
				const A20& v20, const A21& v21, const A22& v22, const A23& v23,
				const A24& v24, const A25& v25, const A26& v26, const A27& v27,
				const A28& v28, const A29& v29, const A30& v30, const A31& v31,
				const A32& v32, const A33& v33, const A34& v34, const A35& v35)
    {
		MYTYPE strFmt;
		if ( strFmt.Load(nId) )
        {
            Fmt(strFmt, FmtArg<A1>(v1)(), FmtArg<A2>(v2)(),
                ...
                FmtArg<A15>(v15)(),FmtArg<A16>(v16)(),FmtArg<A17>(v17)(),
				FmtArg<A18>(v18)(),FmtArg<A19>(v19)(),FmtArg<A20>(v20)(),
				FmtArg<A21>(v21)(),FmtArg<A22>(v22)(),FmtArg<A23>(v23)(),
				FmtArg<A24>(v24)(),FmtArg<A25>(v25)(),FmtArg<A26>(v26)(),
				FmtArg<A27>(v27)(),FmtArg<A28>(v28)(),FmtArg<A28>(v28)(),
				FmtArg<A29>(v29)(),FmtArg<A30>(v30)(),FmtArg<A31>(v32)(),
				FmtArg<A33>(v33)(),FmtArg<A34>(v34)(),FmtArg<A35>(v35)());
        }
    }
...
private:
	...
	{
		if (!g_hModuleSS)
			g_hModuleSS = GetModuleHandle(0);

		return g_hModuleSS;
	}

	inline void SetSSResourceHandle(HMODULE hModule)
	{
		g_hModuleSS = hModule;
	}
